...
const IconWhatsApp = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M20 12a8 8 0 0 1-11.7 7L4 20l1.1-4.2A8 8 0 1 1 20 12Z" stroke="currentColor" strokeWidth="2" fill="none"/>
    <path d="M9.5 9.5c.3-1 .8-1 1.3-.7l.8.5c.3.2.4.6.3.9l-.2.6a.8.8 0 0 0 .2.8l.9 1a.8.8 0 0 0 .8.2l.7-.2c.4-.1.8 0 1 .3l.5.9c.3.5.2 1-.4 1.3-1.7.9-3.8.7-5.7-1.1-1.8-1.7-2.3-3.5-1.9-5 .2-.6.8-.6 1-.3Z" fill="currentColor"/>
  </svg>
)
const IconMail = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
const IconUser = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <path d="M6 19a6 6 0 0 1 12 0" stroke="currentColor" strokeWidth="2" fill="none"/>
  </svg>
)
    ...
    <footer className="fixed bottom-0 inset-x-0 z-40 border-t border-line bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="container py-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <a aria-label="Instagram" href="https://www.instagram.com/procon.ing?igsh=MTV6OWljNjZjYmRlcQ%3D%3D&utm_source=qr" target="_blank" rel="noreferrer" className={circle}>
            <IconInstagram />
          </a>
          <a aria-label="WhatsApp" href="https://wa.me/56973495086" target="_blank" rel="noreferrer" className={circle}>
            <IconWhatsApp />
          </a>
          <a aria-label="Enviar correo" href="#enviar-correo-web" onClick={sendEmail} className={circle}>
            <IconMail />
          </a>
          <Link aria-label="Perfil" to="/" className={circle}>
            <IconUser />
          </Link>
        </div>
      </div>
